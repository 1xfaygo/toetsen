...
# === [kamer 7] === #
print("je loopt de kamer binnen en vindt een ruppee en pakt hem op")
time.sleep(2)
print("--ITEM ADDED TO YOUR INVENTORY--")
inventory.append("ruppee")
print("je loopt door naar de volgende kamer voor je")
print(inventory)
time.sleep(1)
item = random.choice(['schild',"zwaard"])
kamer_keuze = input("door welke deur ga je heen: deur 1 of deur 2")
if kamer_keuze == 1:
    if item == "shild":
        player_defense += 1
    else:
    ...
    if antwoord == uitkomst:
        ...
        sleutel = 0
    print('Je ziet 2 deuren achter het standbeeld.')
    print('')
    time.sleep(1)
    kamer_keuze = input("door welke deur ga je heen: deur 1 of deur 2")
